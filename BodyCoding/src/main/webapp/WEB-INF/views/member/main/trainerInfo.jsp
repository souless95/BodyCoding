...
<br>
	...
	<table class="table" style="border: 3px solid gray;">
		<tr style="border: 2px solid gray;">
			<td style="border: 2px solid gray; width: 300px; height: 400px;" rowspan="4"><img src="/static/uploads/trainer/${trainerInfo.mem_img}" style="width:100%;height:100%; margin-bottom: -55px;"></td>
