...
<script>
   ...
   function openChat(){
      ...
      //선택된 채팅방을 읽어온다.
      var roomName = "member1-Room";
      var adminChatURL = "WebChatA.do?chat_id="+id.value+"&chat_room="+roomName;
      /*
      window.open(오픈할페이지의URL, 창의이름, 창의속성);
         ...
         통해 적용하고 있다.
      */
      window.open("WebChatM.do?chat_id="+id.value+"&chat_room="+roomName, roomName+id.value, "width=500,height=700");
   }
</script>
<div class="container">   
   <h2>슈발 회원새끼</h2>
