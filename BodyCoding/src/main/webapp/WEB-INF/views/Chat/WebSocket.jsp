...
<script>
   ...
   function chatWin(){
      ...
      var memberChatURL = "WebChat.do?chat_id="+id.value+"&chat_room="+roomName;
      
      var adminChatURL = "WebChat.do?chat_id=admin_super1&chat_room="+roomName;
      /*
      ...
      */
      ...
      window.open(adminChatURL, roomName+"-"+"admin_super1", "width=500,height=700");
   }
</script>
<div class="container">   
   ...
   <table border=1 cellpadding="10" cellspacing="0">
      ...
      <tr>
         <td colspan="2" style="text-align:center;">
            <button type="button" onclick="chatWin();" 
