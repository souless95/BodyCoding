...
<!-- <div class="mb-3" name="star_rate" id="star_rates"  style="width: 300px; height: 35px;"> 
	<fieldset>
      	<input type="radio" name="star_rate" value="5" id="star_rate5" name="review_grade">
         	<label for="star_rate5">★</label> 
      	<input type="radio" name="star_rate" value="4" id="star_rate4" name="review_grade">
         	<label for="star_rate4">★</label>
      	<input type="radio" name="star_rate" value="3" id="star_rate3" name="review_grade">
         	<label for="star_rate3">★</label> 
      	<input type="radio" name="star_rate" value="2" id="star_rate2" name="review_grade">
         	<label for="star_rate2">★</label> 
      	<input type="radio" name="star_rate" value="1" id="star_rate1" name="review_grade">
